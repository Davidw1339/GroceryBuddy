...
/**
 * Class representing detailed view page.
 * @extends React.Component
 */
export default class DetailedViewPage extends Component {
  /**
   * Constructs the detailed view page
   * @param  {object} props
   */
  constructor(props) {
    super(props);
  ...
  /**
   * Refreshes the page to grab the data
   */
  ...
  /**
   * Refetches the data from the API by UPC code
   */
  refresh = async () => {
    ...
    let oldPrices = [{ price: Infinity, upvotes: [], downvotes: [] }];
    if (res) {
  ...
  /**
   * Toggles state to show or not show the price overlay
   */
  ...
  /**
  * Renders detailed view page.
  * @return {View} The detailed view page.
  */
  render() {
    ...
    console.log(this.state.oldPrices);
